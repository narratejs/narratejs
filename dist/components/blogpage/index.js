...
const BlogPage = async (props) => {
    ...
    if (!post)
        return notFound();
    return (_jsxs("div", { className: "min-h-screen flex flex-col gap-2 p-5", children: [_jsx(Image, { priority: true, alt: post?.title, width: 600, height: 315, src: post?.image_url }), _jsxs("div", { children: [_jsx("h1", { className: "text-4xl text-blue-700 font-black mb-3", children: post?.title }), _jsxs("p", { className: "-mt-2 text-sm", children: ["Published", " ", new Date(post?.date).toLocaleDateString("en-us", {
                                month: "long",
                                day: "numeric",
                                year: "numeric",
                            })] })] }), _jsx(Markdown, { className: "p-5 md:p-0", components: {
                    a(props) {
